...
const OBSTACLE_GEOMETRY = new THREE.SphereGeometry(0.7, 8, 8); // Base for trash bag
const TRASH_TOP_GEO = new THREE.ConeGeometry(0.4, 0.6, 8); // Knotted top of the bag
const OBSTACLE_RING_GEO = new THREE.TorusGeometry(0.8, 0.05, 8, 24); // Ground ripple for the heavy bag
        ...
        <group ref={groupRef} position={[data.position[0], 0, data.position[2]]}>
            ...
            <group ref={visualRef} position={[0, data.position[1], 0]}>
                ...
                {data.type === ObjectType.OBSTACLE && (
                    <group>
                        {/* Main slumped bag body */}
                        <mesh geometry={OBSTACLE_GEOMETRY} castShadow receiveShadow scale={[1.1, 0.8, 1]} position={[0, 0.3, 0]}>
                        ...
                        {/* The tied/pinched top */}
                        <mesh position={[0, 0.8, 0]} geometry={TRASH_TOP_GEO} castShadow>
                            <meshStandardMaterial
                                color="#111111"
                                roughness={0.3}
                                metalness={0.3}
                        ...
                        <mesh position={[0, 0, 0]} rotation={[-Math.PI / 2, 0, 0]} geometry={OBSTACLE_RING_GEO}>
